...
var RequiredRootDocs = []string{
	...
	"docs/adr/0009-per-user-models.md",
	"docs/adr/0010-container-830-net-bind-service.md",
	"docs/adr/0011-candidate-not-writable-running.md",
	"docs/adr/0012-bounded-capabilities.md",
	"docs/adr/0013-notification-log-ephemeral.md",
	"docs/adr/0013-restconf-dedicated-listener.md",
	"docs/adr/0014-host-residual-10830.md",
...
// RequiredPhrases must appear in docs/ (NAT / userland-proxy invariant).
...
func Check(root string) error {
	...
	err := filepath.WalkDir(root, func(path string, d os.DirEntry, err error) error {
		...
		if d.IsDir() {
			base := d.Name()
			if base == ".git" || base == "testdata" || base == "vendor" || base == "node_modules" || base == "dist" || base == "go-lab-netconf-design-pack" {
				return filepath.SkipDir
			}
			return nil
		}
		if !strings.HasSuffix(path, ".md") || d.Name() == "IMPLEMENTATION-DESIGN.md" {
			return nil
		}
