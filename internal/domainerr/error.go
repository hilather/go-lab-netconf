...
func CallHomeUnsupported(message string, violations ...FieldViolation) *Error {
	return New(CodeCallHomeUnsupported, message).WithViolations(violations...)
}
...
func LockDenied(message string) *Error {
	return New(CodeLockDenied, message)
}

func NotWritable(message string) *Error {
	return New(CodeNotWritable, message)
}

func WaitTimeout(message string) *Error {
	return New(CodeWaitTimeout, message)
}

func StoreWiped(message string) *Error {
	return New(CodeStoreWiped, message)
}
...
func CandidateDirty(message string) *Error {
	return New(CodeCandidateDirty, message)
}

func ImmutableField(message string, violations ...FieldViolation) *Error {
	return New(CodeImmutableField, message).WithViolations(violations...)
}
