...
func TestSessionCookieAndCSRF(t *testing.T) {
	...
	if CookieName != "labnetconf_session" || CSRFHeader != "X-LabNETCONF-CSRF" {
...
func TestOriginAllowlist(t *testing.T) {
	...
	if err := CheckOrigin("https://lab.example", []string{"https://other.example"}); err == nil {
		t.Fatal("exact match required")
	}
